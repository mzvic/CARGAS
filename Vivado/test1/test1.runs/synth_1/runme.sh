...
HD_PWD='/home/mzvic/CePIA/CARGAS/Vivado/test1/test1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arch_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source arch_wrapper.tcl
