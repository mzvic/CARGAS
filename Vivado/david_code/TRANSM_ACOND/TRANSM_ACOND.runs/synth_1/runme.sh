...
HD_PWD='C:/Users/David/Desktop/Radiometro/TRANSM_ACOND/TRANSM_ACOND.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AD1_PV1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AD1_PV1.tcl
