...
HD_PWD='C:/Users/David/Desktop/Radiometro/TRANSM_ACOND/TRANSM_ACOND.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AD1_PV1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source AD1_PV1.tcl -notrace
