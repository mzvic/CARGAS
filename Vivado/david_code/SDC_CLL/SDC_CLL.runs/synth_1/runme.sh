...
HD_PWD='C:/Users/David/Desktop/Hardware/Cargas/02_09_22/SDC_CLL/SDC_CLL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SDC_CLL_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SDC_CLL_wrapper.tcl
