...
HD_PWD='C:/Users/David/Desktop/Hardware/Cargas/02_09_22/SDC_CLL/SDC_CLL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SDC_CLL_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SDC_CLL_wrapper.tcl -notrace
