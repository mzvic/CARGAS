...
HD_PWD='/home/mzvic/CARGAS/PT100/tempsensordriver/tempsensordriver.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ts_pt100_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ts_pt100_wrapper.tcl
