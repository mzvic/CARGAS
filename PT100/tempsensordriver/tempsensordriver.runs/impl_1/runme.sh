...
HD_PWD='/home/mzvic/CARGAS/PT100/tempsensordriver/tempsensordriver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ts_pt100_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ts_pt100_wrapper.tcl -notrace
